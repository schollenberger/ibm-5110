...
0020 REM 2025-07-22 WERNER SCHOLLENBERGER
0030 REM ****
0040 DIM X$2(256)
0050 REM A$ - ANSWER,  M$ - STORED ANSER , B$ - SERIAL DATA
...
0590 PRINT FL4
0600 RETURN
0610 REM SENDING EOT CHAR AT THE END
0614 PRINT 'SENDING EOT...'
0615 E$=X'AC'
0620 PRINT FL4,E$
0630 REM PRINT FL4
0640 REM PRINT
